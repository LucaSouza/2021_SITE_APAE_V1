...
<div class="row container-titulo-section container-sem-slide justify-content-center">
    <div class="col-12">
      <h1 class="titulo-section-inicio">Meio Ambiente e Sustentablidade</h1>
    </div>
    <p class="texto-geral mt-5 col-12 col-sm-12 col-md-12 col-lg-10 col-xl-9 col-xxl-9 text-justify">
O<b> Programa Meio Ambiente e Sustentabilidade</b>, proporcionar o conhecimento e a conscientização, acerca dos temas que envolvam meio ambiente e cidadania, desenvolvendo a construção de atitudes para a preservação, com o desenvolvimento sustentável. 
    </p>
</div>
<div class="container-projetos row justify-content-center">
    ...
    <div class="owl-container-projetos-corpo owl-theme owl-carousel col-12 col-sm-12 col-md-12 col-lg-10 col-xl-9 col-xxl-9">
        <!-- Slides -->
        @foreach ($sustentabilidade as $projeto)
