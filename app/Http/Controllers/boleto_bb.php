...
$valor_cobrado = "11,00"; // Valor - REGRA: Sem pontos na milhar e tanto faz com "." ou "," ou com 1 ou 2 ou sem casa decimal
...
$dadosboleto["cedente"] = "ASSOC DE PAIS E AMIGOS DOS EXCEPCIONAIS NOVA ANDRADINA";

// N�O ALTERAR!
include("funcoes_bb.php"); 
include("17_layout_bb.php");
?>
