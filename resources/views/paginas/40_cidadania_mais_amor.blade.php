...
<div class="row container-titulo-section container-sem-slide justify-content-center">
    <div class="col-12">
      <h1 class="titulo-section-inicio">Cidadania Mais Amor</h1>
    </div>
    
    <p class="texto-geral mt-5 col-12 col-sm-12 col-md-12 col-lg-10 col-xl-9 col-xxl-9 text-justify">
     O <b>Programa Cidadania Mais Amor</b>, na APAE, tem por objetivo, fomentar junto as famílias o conhecimento e a apropriação de recursos e saberes para o enfrentamento de suas dificuldades, prevenir e restabelecer ruptura de vínculos familiares e sociais, rompendo com padrões violadores de direitos e contribuindo na melhoria da qualidade de vida de Pessoas com Deficiência Intelectual e Múltipla, através de oficina  de aperfeiçoamento, lazer e geração de renda, artesanato, culinária, orientação sobre gestão financeira, palestras, mesa redonda e dinâmicas de grupos, etc.... 
    </p>
