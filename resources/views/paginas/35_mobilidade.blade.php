...
<div class="row container-titulo-section container-sem-slide justify-content-center">
    <div class="col-12">
      <h1 class="titulo-section-inicio">Transporte e Mobilidade</h1>
    </div>
    
    <p class="texto-geral mt-5 col-12 col-sm-12 col-md-12 col-lg-10 col-xl-9 col-xxl-9 text-justify">
      O <b>Programa Transporte e Mobilidade</b>, por meio de projetos busca identificar e eliminar todos os obstáculos e barreiras, garantindo à pessoa com deficiência mobilidade e acesso aos serviços ofertados na instituição e usufruir de seus direitos de cidadania e de participação social.
    </p>
</div>
