...
<div class="row container-titulo-section container-sem-slide justify-content-center">
    <div class="col-12">
      <h1 class="titulo-section-inicio">Equoterapia</h1>
    </div>
    
    <p class="texto-geral mt-5 col-12 col-sm-12 col-md-12 col-lg-10 col-xl-9 col-xxl-9 text-justify">
      O<b> Serviço de Equoterapia</b>, trabalha aspectos afetivo, cognitivo, motores, sensoriais e sociais, tendo por fatores particulares: o equino, o ambiente e a equipe interdisciplinar, abrangendo os programas básicos: hipoterapia, educação/reeducação, pré - esportiva e prática esportiva para equestre, através de: entrevista inicial, avaliação médica, avaliação, planejamento terapêutico, terapias semanais, monitoramento e reavaliação.
    </p>
</div>
